...
3. **Choose** your difficulty level (Easy/Medium/Hard)
...
3. **Type Away**: Type the sentence shown above the input area
4. **Monitor Progress**: Watch your WPM, accuracy, and time in real-time
